...
public class JwtService {
    ...
    /**
     * Generates a token with no extra claims for the given user.
     */
    ...
    /**
     * Generates a token with additional claims (e.g., role, userId) for the given user.
     */
...
//        Also add individual role for easier frontend access
    ...
    /**
     * Validates the token by checking the username match and expiry.
     */
