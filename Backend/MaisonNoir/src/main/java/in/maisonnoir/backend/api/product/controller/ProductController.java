...
public class ProductController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProductDTO> updateProduct(@PathVariable String id, @RequestBody ProductDTO updatedDTO) {
        ProductDTO updated = productService.updateProduct(id, updatedDTO);
        return ResponseEntity.ok(updated);
    }

    @PatchMapping("/{id}")
    public ResponseEntity<ProductDTO> updateFields(@PathVariable String id, @RequestBody Map<String, Object> updatedFields) {
