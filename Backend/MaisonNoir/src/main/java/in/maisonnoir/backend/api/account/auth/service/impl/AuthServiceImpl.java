package in.maisonnoir.backend.api.account.auth.service.impl;
...
import in.maisonnoir.backend.api.account.auth.service.AuthService;
...
public class AuthServiceImpl implements AuthService {
    ...
    private AuthResponseDTO buildAuthResponse(UserEntity user, String message) {
